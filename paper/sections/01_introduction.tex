...
How large is the fiscal multiplier, and what determines its size? Three
empirical regularities must be matched simultaneously by any serious model of
fiscal transmission \citep{Auclert2024}: high marginal propensities to consume
(MPCs $\approx$ $0.25$ quarterly, $0.5$ annually; \citealp{KaplanViolante2014,Fagereng2021}),
low marginal propensities to earn (MPEs $\in [0, 0.04]$ annually;
\citealp{Cesarini2017}), and moderate fiscal multipliers ($0.6$--$2.0$;
\citealp{Ramey2019,Christiano2011,Woodford2011}). \auclert{} show these facts
form a \emph{trilemma}: in New Keynesian models with frictionless labor
supply, no separable-preference calibration can match all three.

\smallskip
The extant solutions operate through the labor-supply margin. \auclert{}
themselves propose sticky wages. \BHL{} solve the trilemma through
consumption--labor complementarity $U_{cn}\neq 0$. We propose a third,
orthogonal resolution that operates through the \emph{government-spending}
margin. Extending household utility from $U(c,n)$ to $U(c,g,n)$ turns
public-good provision into a direct preference-shifter: the cross-partial
$U_{cg}^{j} \neq 0$ captures \EC{} between private consumption and publicly
provided goods. This extension is empirically well-documented
\citep{Karras1994,JallesKarras2022,FrancoisKeinsley2023,Francois2023,BarthelFrancois2025,Bilbiie2011}
and distributionally heterogeneous: poor households complement public
provision (public health raises the value of private nutrition; public
transit enables labor-force participation), while wealthy households
privately substitute (private healthcare, private schools, private
security). \citet{Gethin2023} documents exactly this gradient: public goods
are disproportionately consumed by the bottom of the income distribution,
with incidence that is both large (public provision accounts for $30\%$ of
global GDP and $20\%$ of global poverty reduction since $1980$) and sharply
regressive.
